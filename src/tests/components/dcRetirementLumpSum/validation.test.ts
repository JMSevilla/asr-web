import { ChangeLumpSumForm, changeLumpSumSchema } from '../../../components/blocks/dcRetirementLumpSum/validation';
import { generateFormValues } from '../../mock';

const MIN = 100;
const MAX = 1000;
const validForm: ChangeLumpSumForm = { taxFreeLumpSum: 500, percentage: '' };
