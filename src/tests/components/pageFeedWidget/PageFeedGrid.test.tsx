...
import { PageFeedGrid } from '../../../components/blocks/pageFeedWidget/PageFeedGrid';
import { render, screen } from '../../common';

const DEFAULT_PROPS: React.ComponentProps<typeof PageFeedGrid> = {
...
describe('PageFeedGrid', () => {
  it('renders PageFeedGri component', () => {
    render(<PageFeedGrid {...DEFAULT_PROPS} />);
    expect(screen.queryByTestId('page-feed-grid')).toBeTruthy();
  });
  it('should render grid component with widgets', () => {
    render(<PageFeedGrid {...DEFAULT_PROPS} />);
    expect(screen.queryAllByText('[[page-feed-widgets-read-more]]')).toHaveLength(3);
    expect(screen.queryByText('Grid Container Header')).toBeInTheDocument();
  ...
  it('should render grid component with cards', () => {
    render(<PageFeedGrid {...DEFAULT_PROPS} cards={CARDS} />);
    expect(screen.queryByText('Grid Container Header')).toBeInTheDocument();
