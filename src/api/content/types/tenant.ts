...
export interface CmsTenant {
  ...
  newlyRetiredRange?: NumberValue;
  preRetiremetAgePeriod?: NumberValue;
  realm: StringValue;
  hideHelp?: BooleanValue;
  hideHelpButtons?: BooleanValue;
  hideLivechat?: BooleanValue;
  enableLinkedRecords?: BooleanValue;
  increasedAccessibility?: BooleanValue;
  clientCountryIdSaDirectRoutes?: StringValue;
  clientCountryIdPostSsoRoutes?: StringValue;
  clientCountryIdWorkEmail?: StringValue;
  clientIdAppRegistration?: StringValue;
  outboundSsoUrl?: StringValue;
}
