...
import { TasksValue } from './globals';
...
export interface TaskItemValues {
  elements?: TaskItemElementValues;
  id: string;
}

export interface TaskContainerValues {
  elements?: TaskContainerElementValues;
}
export interface TaskContainerElementValues {
  taskIconIfZero?: { elementType: string };
  key?: StringValue;
  caption?: StringValue;
  accessGroups?: AccessGroupsValue;
}
export interface TaskItemElementValues {
...
interface PageElements
  ...
  chart?: MixedValue<{ elements: ChartElements } | undefined>;
  footerIcon?: FileValue;
  caption?: StringValue;
  captionIfData?: StringValue;
  taskIconIfDone?: StringValue;
  captionIfZero?: StringValue;
  iconIfZero?: StringValue;
