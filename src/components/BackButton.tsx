...
export const BackButton: React.FC<Props> = ({ label, link, isNativeBack, isInStickOutPage, loading, onClick }) => {
  ...
  return (
    <Button
      ...
      href={link ?? undefined}
      onClick={handleClick}
      sx={{ display: 'flex', flexWrap: 'nowrap', alignItems: 'center', cursor: 'pointer' }}
    >
      <ChevronLeft color={isLoading ? 'disabled' : 'primary'} sx={{ fontSize: isInStickOutPage ? 32 : 40, mb: 1 }} />
      <Typography
